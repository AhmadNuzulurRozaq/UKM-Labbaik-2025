...
<div class="container container-main py-5 text-center">
    ...
    <!-- Judul Halaman -->
    <h1 class="mb-4">Departemen PSDM</h1>
    ...
    <!-- Bagian Kepengurusan -->
    <h2 class="mb-4 pt-3">Kepengurusan Departemen PSDM</h2>
        ...
        <div class="col-12 col-md-6">
            <div class="card member-card text-start h-100 p-3">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <img src="{{ asset('images/anggota/imagecard.jpg') }}"
    ...
    <!-- Program Kerja -->
    <h2 class="mb-4">Program Kerja Departemen PSDM</h2>
