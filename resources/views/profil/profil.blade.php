...
<head>
    ...
    <style>
        ...
        /* Tulisan overlay di atas gambar */
        .card-titel {
            position: absolute;
            bottom: 15px;
            left: 15px;
...
<body class="bg-light">
    <main class="container-fluid px-6 py-4" style="max-width: 80%;">
        <section class="mb-5">
            <div class="row g-4">
                <div class="col-md-3">
                    <div class="p-4 bg-white border border-2 border-light rounded-3 shadow-sm text-center">
                        <img src="{{ asset('/images/logo/logoukm.png')}}" alt="Logo" style="height: 100px; width: 100px">
                        <br>
                ...
                <div class="col-md-9">
                    <!-- <div class="profile-card-bg rounded-3 p-4 position-relative d-flex align-items-end justify-content-between"
                        style="height: 100%;">
                        <img src="{{ asset('/images/dokumentasi/masjidpolije.png')}}" alt="Masjid" style="max-width: 100%;">
                        <span class="fs-4 fw-bold text-dark">EXAMPLE NAME</span>
                    </div> -->
                    <div class="profile-card-bg rounded-3 position-relative overflow-hidden"
                        style="height: 250px;">

                        <!-- IMAGE FULL CARD -->
                        <img src="{{ asset('/images/dokumentasi/masjidpolije.png') }}"
                            alt="Masjid"
                            class="card-imager">

                        <!-- TEXT OVERLAY -->
                        <span class="card-titel">MASJID RAYA AL-ISTIQOMAH</span>
                    </div>
        ...
        <hr class="my-5 border-2">
        <section class="mb-5 section-center">
            <h2 class="fs-2 fw-bolder profile-section-title mb-4 text-center">Struktur Organisasi</h2>
            <div class="row g-4 mb-5 bg-light mx-auto" style="max-width: 90%;">
                <!-- Card 1 -->
                <div class="col-12 col-md-6">
                    <div class="card member-card text-start h-100 p-3">
                        <div class="d-flex align-items-center mb-3">

                            <img src="{{ asset('images/anggota/bagustriandhani.jpg') }}" alt="Foto Nuril Khoirifah"
                                class="rounded me-3" style="width: 130px; height: 200px; object-fit: cover;">

                            <div class="card-text">
                                <h5 class="card-title fw-bold mb-0">Bagus Tri Andhani</h5>
                ...
                <div class="col-12 col-md-6">
                    <div class="card member-card text-start h-100 p-3">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <img src="{{ asset('images/anggota/nailatulkarimah.jpg') }}" alt="Foto Nuril Khoirifah"
                                class="rounded me-3" style="width: 130px; height: 200px; object-fit: cover;">
                ...
                <div class="col-12 col-md-6">
                    <div class="card member-card text-start h-100 p-3">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <img src="{{ asset('images/anggota/wedarherlanac.jpg') }}" alt="Foto Nuril Khoirifah"
                                class="rounded me-3" style="width: 130px; height: 200px; object-fit: cover;">
                ...
                <div class="col-12 col-md-6">
                    <div class="card member-card text-start h-100 p-3">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <img src="{{ asset('images/anggota/videlmasufiromadhani.jpg') }}" alt="Foto"
                                class="rounded me-3" style="width: 130px; height: 200px; object-fit: cover;">
                ...
                <div class="col-12 col-md-6">
                    <div class="card member-card text-start h-100 p-3">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <img src="{{ asset('images/anggota/tidakadafoto.jpg') }}" alt="Foto Nadya Salsa Bella"
                                class="rounded me-3" style="width: 130px; height: 200px; object-fit: cover;">
                ...
                <div class="col-12 col-md-6">
                    <div class="card member-card text-start h-100 p-3">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <img src="{{ asset('images/anggota/tanayaviorellamerizaekawulandari.jpg') }}" alt="Foto Nadya Salsa Bella"
                                class="rounded me-3" style="width: 130px; height: 200px; object-fit: cover;">
